...
export default function Register({ onRegisterComplete, onCancel }: RegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        onRegisterComplete(); // Prebaci na login
      }, 3000);
    } catch (err: any) {
    ...
    <div style={{ padding: "2rem" }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          style={{ display: "block", marginBottom: "1rem", padding: "0.5rem" }}
        />
        <button type="submit" style={{ marginRight: "1rem" }}>Registruj se</button>
